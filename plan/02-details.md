...
- Audience: HR recruiter dan tech lead
- Nama: Aqil Sulthan
- Role: Cloud Engineer
...
- LARANGAN: Framework (Bootstrap, Tailwind, dll)

Yang WAJIB:
- Semantic HTML5 elements (`<header>`, `<nav>`, `<main>`, `<section>`, `<article>`, `<footer>`)
- Responsive mobile-first (320px - 1440px+)
- Accessibility basics (WCAG 2.1 AA): skip link, alt text, aria-label, focus visible, color contrast
